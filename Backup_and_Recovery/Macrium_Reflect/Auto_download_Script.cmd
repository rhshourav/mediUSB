...
set base_url=https://raw.githubusercontent.com/rhshourav/mediUSB/main/Backup_and_Recovery/Macrium_Reflect/Macrium_Reflect.part
set file_prefix=Macrium_Reflect.part
...
for /l %%i in (%start%, 1, %end%) do (
    ...
    if %%i geq 10 if %%i lss 11 (set part_number=%%i)
